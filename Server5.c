...
int main(int argc, char *argv[]){
	...
	while (1){
		...
		while (1){
			...
			fflush(stdout);
			if(strncmp(receive_buffer,"USER",4)  && strncmp(receive_buffer,"PASS",4)&&  strncmp(receive_buffer,"QUIT",4)&&  strncmp(receive_buffer,"PWD",3)&&  strncmp(receive_buffer,"TYPE",4)&&  strncmp(receive_buffer,"SYST",4) &&strncmp(receive_buffer,"PORT",4)&&strncmp(receive_buffer,"LIST",4)  &&  strncmp(receive_buffer,"NLST",4)&& strncmp(receive_buffer,"STOR",4)&&  strncmp(receive_buffer,"RETR",4)){
